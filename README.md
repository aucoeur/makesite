...
[![Go Report Card](https://goreportcard.com/badge/github.com/aucoeur/makesite)](https://goreportcard.com/report/github.com/aucoeur/makesite)
...
- [x] Edit line `3` of `README.md`. Change this line to the following, replacing `YOUR_USERNAME` and `YOUR_REPONAME` with your GitHub username and repository name respectively.
